...
#'@param method the specific construction of prior konelwdge in PMS method. "spatial_fixed" indicates Lambda is a known matrix;
...
#'@param Lambda a numeric matrix of known prior covariance knowledge. Similarly, we can choosed "Lambda" as identity matrix if prior covariance knowledge is unavailable in
